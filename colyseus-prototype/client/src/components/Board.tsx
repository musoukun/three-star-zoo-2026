    ...
    <div className="game-layout-mobile">
      ...
      <div className="mobile-status-bar">
        ...
        {state.phase === 'main' && state.chanceDeckCount > 0 && (
          <span style={{ fontSize: 10, color: 'rgba(255,255,255,0.6)', cursor: 'help' }} title="チャンスカード：サイコロの合計が11以上の時に引ける特殊カード。即使用か伏せて保持を選べます"><Emoji name="card" size={12} />{state.chanceDeckCount}枚</span>
        )}
    ...
    <div className="game-layout">
      ...
      <div className="main-area">
        ...
        <div className="status-bar">
          ...
          {state.phase === 'main' && state.chanceDeckCount > 0 && (
            <span style={{ fontSize: 14, color: '#fff', cursor: 'help' }} title="チャンスカード：サイコロの合計が11以上の時に引ける特殊カード。即使用か伏せて保持を選べます"><Emoji name="card" size={15} />{state.chanceDeckCount}枚</span>
          )}
